...
#
# Script generated by Vivado on Tue Apr 28 19:24:44 CEST 2026
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gen_clks.sh
...
#
# Usage        : gen_clks.sh
#                gen_clks.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gen_clks.sh [-reset_run]
#                gen_clks.sh [-reset_log]
#                gen_clks.sh [-help]
#
...
#                script (type 'gen_clks.sh -help' for more information).
#
...
# script info
echo -e "gen_clks.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gen_clks.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gen_clks xil_defaultlib.glbl -o gen_clks_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gen_clks_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gen_clks_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gen_clks_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gen_clks.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gen_clks.sh [-help]\n\
Usage: gen_clks.sh [-step]\n\
Usage: gen_clks.sh [-lib_map_path]\n\
Usage: gen_clks.sh [-reset_run]\n\
Usage: gen_clks.sh [-reset_log]\n\
Usage: gen_clks.sh [-keep_index]\n\
Usage: gen_clks.sh [-noclean_files]\n\n\
